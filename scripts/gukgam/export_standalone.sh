...
| 페이지 | 내용 |
|---|---|
| `index.html` (= `gukgam.html`) | 홈 — 통합검색 · 큰 메뉴 5개(2025 국감·복지부·질병청·식약처·코로나19) · 자동 인사이트 · 위원 명단(현재·역대) |
| `gukgam-2025.html` | 2025년 국정감사 — 확정 일정·하이라이트·지적사항·위원·회의록 |
| `gukgam-all.html` | 전체 자료·도구 — 하이라이트·연대기·국회일정·위원 프로필·브리핑·자료 목록 |
