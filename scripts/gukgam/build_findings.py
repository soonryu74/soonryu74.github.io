...
SUBJECT_KEYS = [
    ...
    ("국제협력·ODA", ["ODA", "국제협력", "해외사무소", "국제기구", "재외", "식약관"]),
    ("의약품·마약류", ["의약품", "마약", "제약", "약가", "품절약", "임상시험", "허가", "바이오시밀러",
                   "바이오의약품", "처방", "의약외품", "약국", "마취"]),
    # 식약처 소관은 결과보고서 문장에 병명·제도명 대신 제품·규제 용어가 나온다.
    # 이 세 분류가 없을 때 식약처 지적의 18%가 미분류였다(담배 유해성, GMO 표시제, 수입검사…)
    ("담배·유해물질", ["담배", "니코틴", "유해성분", "유해물질", "유해성"]),
    ("표시·광고", ["표시제", "표시광고", "부당광고", "허위광고", "과대광고", "강조 표시", "표시할",
                "표시 할", "표시하도록", "표시기준", "표시 기준", "광고"]),
    ("수입·수출", ["수입식품", "수입검사", "통관", "수출", "해외직구", "직구", "해외제조업소", "현지실사"]),
    ("식품·의료기기", ["식품", "식중독", "의료기기", "화장품", "위생", "식품첨가물", "잔류농약", "글리포세이트",
                   "건강기능식품", "소비기한", "유통기한", "이물", "카페인", "당류", "당알코올", "안전성",
                   "위해성", "위해요소", "위해식품", "농산물", "축산물", "수산물", "검사센터"]),   # "위해"는 "~를 위해"에 다 걸리므로 금지
]
...
NATURE_KEYS = [
    ...
    ("연구·R&D", ["연구", "R&D", "임상연구", "학술", "동물대체시험", "시험법"]),
