...
},
{
  ...
  caveat: "단기, 제약사 소속 공저자 포함, 로페콕시브는 현재 시판 안 됨.",
  grade: "B",
...
},
{
  ...
  ing: ["gut"],
  outcome: ["other"],
  effect: ["CUSABIO 키트: 합토글로빈·보체 C3 검출", "Immundiagnostik 키트: 보체 C3 검출"],
...
},
{
  ...
  caveat: "단일 연구로 재현되지 않음, 위약 반응률 5.8%가 이례적으로 낮음, 무작위 배정 인원 초록 미기재. 일반 '장누수' 소비자에게 일반화 불가.",
  grade: "B",
...
},
{
  ...
  ing: ["probiotic", "fiber"],
  outcome: ["gut"],
  effect: ["프로·신바이오틱스 LPS: SMD −0.54 (−1.01~−0.07), I² 94%, 확실성 매우 낮음", "프로·신바이오틱스 조눌린: SMD −0.49 (−0.79~−0.18), 13편 n=778", "프리바이오틱스 LPS: SMD −0.88 (−1.28~−0.47), 16 RCT n=792"],
...
},
{
  ...
  ing: ["probiotic", "vitd"],
  outcome: ["gut"],
  effect: ["조눌린 감소 (16주 군간 차 −19.0 ng/mL, 계획서 순응 분석)", "락툴로스/만니톨 비·증상 점수·삶의 질은 군간 차이 없음"],
