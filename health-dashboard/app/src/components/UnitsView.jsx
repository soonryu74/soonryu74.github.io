    ...
    <div className="units">
      <div className="card">
        ...
        <div className="unitsdoc">
          <p><b>조사 단위는 행정안전부 행정구역이 아니라 보건소입니다.</b> 지역사회건강조사는 매년 전국 보건소가 각자 관할 주민 약 900명을 조사하고, 통계도 보건소 단위로 만들어집니다. 질병관리청 공식 목록 기준 <b>{UNITS.official_count}곳</b>(2025년 KOSIS 수록 단위 {yearly[yearly.length - 1].units}개), 행정안전부 기초자치단체는 229곳(2025년)입니다.</p>
      ...
      <div className="grid2">
        ...
        <div className="card">
          ...
          <div className="desc">질병관리청 공식 참여 보건소: 2024–2025년 258곳. KOSIS 수록 단위가 2~3개 더 많은 것은 제주시·서귀포시가 "시 전체 행 + 보건소 3곳"으로 수록되기 때문입니다.</div>
        </div>
