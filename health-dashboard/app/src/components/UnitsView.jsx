    ...
    <div className="units">
      <div className="card">
        ...
        <div className="unitsdoc">
          ...
          <p><b>전국 시군구 순위의 분모</b>는 229곳이 기준이고, 그 지표·그 해에 값이 없는 시군구가 있으면 그만큼 줄어듭니다(예: 2025년 지역사회건강조사 지표는 대부분 229곳, 일부 224곳). 청원군(2014년 청주 통합)·연기군(2012년 세종 출범)은 과거 연도에만 들어갑니다. 제주시·서귀포시 안의 보건소 3곳씩은 세부 단위로 두어 전국 시군구 순위에 중복으로 들어가지 않습니다.</p>
