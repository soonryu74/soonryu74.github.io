...
SPEC = [
 ...
 ("K_USE_PT", "의료기관 진료실인원(인구 천명당)", D3, None, r"^의료기관진료실인원_전체$", "per1k", "명/천명"),
 ("K_USE_COST", "1인당 의료기관 진료비", D3, None, r"^의료기관진료비_전체$", "percap", "원"),
 ("K_USE_HTN", "고혈압 진료실인원(천명당)", D3, None, r"^고혈압_진료실인원$", "per1k", "명/천명"),
 ("K_USE_DM", "당뇨병 진료실인원(천명당)", D3, None, r"^당뇨병_진료실인원$", "per1k", "명/천명"),
 ("K_USE_MENT", "정신질환 진료실인원(천명당)", D3, None, r"^정신질환_진료실인원$", "per1k", "명/천명"),
 ("K_USE_ARTH", "관절염 진료실인원(천명당)", D3, None, r"^관절염_진료실인원$", "per1k", "명/천명"),
 ("K_USE_PERIO", "치주질환 진료실인원(천명당)", D3, None, r"^치주질환_진료실인원$", "per1k", "명/천명"),
 ("K_USE_LIV", "간질환 진료실인원(천명당)", D3, None, r"^간질환_진료실인원$", "per1k", "명/천명"),
 ("K_USE_STO", "위암 진료실인원(10만명당)", D3, None, r"^위암_진료실인원$", "per100k", "명/10만명"),
 ("K_USE_LUNG", "폐암 진료실인원(10만명당)", D3, None, r"^폐암_진료실인원$", "per100k", "명/10만명"),
 ("K_USE_COL", "대장암 진료실인원(10만명당)", D3, None, r"^대장암_진료실인원$", "per100k", "명/10만명"),
 ("K_USE_BRE", "유방암 진료실인원(10만명당)", D3, None, r"^유방암_진료실인원$", "per100k", "명/10만명"),
