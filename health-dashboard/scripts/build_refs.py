...
REFS = [
    ...
    {"key": "mort", "org": "국가데이터처(옛 통계청)", "title": "사망원인통계 — 시군구별 연령표준화 사망률",
     "detail": "KOSIS 101 DT_1B34E13 · 표준화사망률 22종 · 2008~2024", "url": COV["mort"]["url"], "updated": upd("mort")},
    ...
    {"key": "cpstf", "org": "Community Preventive Services Task Force(미국)", "title": "The Community Guide — All Active Findings (2024-11)",
     "detail": "권고 224건 · 22개 주제", "url": "https://www.thecommunityguide.org/media/pdf/cpstf-finding-lists/CPSTF-All-Findings-508.pdf", "updated": "2024-11"},
