 ...
 **{k: E("bad", "암 진료인원은 발생(↓ 목표)과 생존 치료 지속(↑)이 섞임. HP2030 암 발생률·사망률 감소 목표에 따라 낮을수록 좋음으로 두되 해석 주의", "KR_HP2030", "PLACES_OUT") for k in ["K_USE_STO","K_USE_LUNG","K_USE_COL","K_USE_BRE"]},
 ...
 # 2018 검진제도 개편(2차 검진 폐지) 이후 1차 판정 기준 별도 지표 — 정의가 다르므로 K_CHK_HTN·K_CHK_DM 과 직접 비교 금지
 "CHK_HTN_S": E("bad", "1차 판정 고혈압 「질환의심」 비율은 미진단·미조절 고혈압의 대리 지표(HP2030 고혈압 인지율·조절률 향상 목표의 뒷면). 2018년 2차 검진 폐지 후 신설 정의라 2017년 이전 「판정 비율」과 이어지지 않음", "KR_HP2030", "HP_HDS04", "KR_NHIS_CHK"),
 "CHK_DM_S": E("bad", "1차 판정 당뇨병 「질환의심」 비율은 미진단 당뇨의 대리 지표(HP2030 당뇨 인지율 향상 목표의 뒷면). 2018년 이후 신설 정의", "KR_HP2030", "HP_D", "KR_NHIS_CHK"),
 "CHK_HTN_D": E("bad", "1차 판정 고혈압 「유질환자」(이미 진단·치료 중) 비율은 유병률 대리(HP2030 성인 고혈압 유병률 감소 목표). 2018년 이후 신설 정의", "KR_HP2030", "HP_HDS04", "KR_NHIS_CHK"),
 "CHK_DM_D": E("bad", "1차 판정 당뇨병 「유질환자」 비율은 유병률 대리(HP2030 당뇨 유병률 감소 목표). 2018년 이후 신설 정의", "KR_HP2030", "HP_D", "KR_NHIS_CHK"),
 # ── 보건의료자원 ──
