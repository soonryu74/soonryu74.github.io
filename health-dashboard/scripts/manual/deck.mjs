...
shot({ t: '3.1 지표 분석 — 단계구분도 ② 전국 시군구 · ③ 시도 내 시군구', img: ['B_map_nation'], img2: ['B_map_insido'],
  bullets: ['전국 시군구: 229곳 전체 분포(그 해 값이 있는 곳). 분위는 전국 기준.', '시도 내 시군구: 우리 시도만 확대, 분위도 시도 안에서 다시 계산.', '값 없는 지역은 회색.'],
...
shot({ t: '3.6 연관지표 — 두 지표의 관계', sub: '산점도 · 피어슨/스피어만/켄달 상관계수 · 연도별 상관', img: ['G_corr_01'], img2: ['G_corr_02'],
  bullets: ['X·Y 지표를 고르면 전국 시군구(최대 229곳) 산점도와 상관계수, 근사 p값이 나옵니다.', '우리 지역 점은 강조 표시.', '상관은 인과가 아닙니다. 고령화율처럼 둘 다에 영향을 주는 제3의 요인을 생각하십시오.'],
