...
statsSlide({
  ...
  stats: [
    ...
    { n: '2008~2025', size: 32, l: '연도 범위', d: '지역사회건강조사 18년{r:chs}. 사망원인 2008~2025{r:mort}, 검진 2010~2024{r:nhis}' },
...
tableSlide({
  ...
  rows: [
    ...
    ['사망원인통계 · 건강수명{r:mort,hle}', '2025', '2027년 9월 하순', '2025년분 2026-09-22 공표 → 9-25 반영. 영아사망률만 2024년(원천 표가 다름)'],
    ['국가암검진 · 일반건강검진{r:cancer,nhis}', '2024', '2026년 12월~2027년 1월', '검진 판정은 2018년 제도 개편으로 정의 변경'],
    ['미세먼지·초미세먼지{r:env}', '2020', '—', '원천 DB 갱신 대기'],
    ['의료기관 진료실인원(인구 천명당){r:nhis}', '2021', '—', '원천 DB 갱신 대기'],
    ['등록장애인 비율 2017 · 사회복지시설·교통사고 건수 2022 · 병상 수 2023', '2017~2023', '—', '원천 DB 갱신 대기(지표별 최신 연도는 자료원 탭)'],
...
shot({ t: '연도 이동과 재생', sub: '슬라이더를 끌거나 ▶ 를 누르면 지도·순위·타일이 해마다 바뀝니다', img: ['A_home_top'],
  bullets: ['연도는 지표마다 다릅니다(지역사회건강조사 2008~2025, 사망원인 ~2025, 검진 ~2024).', '▶ 재생은 한 해씩 넘어가며 지도 색과 순위 자리가 움직입니다.', '연도별 추이표에서 행을 눌러도 그 연도로 이동합니다.'],
...
shot({ t: '3.1 지표 분석 — 이 지표의 현행 근거 지침', sub: '영국 NICE 가이드라인{r:nice} + 미국 CPSTF 권고{r:cpstf}', img: ['B_evidence'],
  bullets: ['지표와 직접·부분 관련된 NICE 가이드라인, 발표·최종 갱신 연도, 권고 수(권고·고려·반대·근거 불충분)를 보여 줍니다.', '판정 배지: 현행(최근 10년 내 갱신) · 얇음 · CPSTF만 · 오래됨 · 없음.', 'CPSTF 권고는 15년 이상 지난 것이 많아 보조로만 표시합니다. 「CPSTF 권고 N건 보기」를 펼치면 권고마다 판정·연도와 원문 링크(Community Guide)가 있습니다.'],
