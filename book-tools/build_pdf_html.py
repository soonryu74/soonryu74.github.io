...
.chapter h3 { string-set: chaptertitle content(text); text-align: center; font-size: 13pt; font-weight: 700; margin: 16mm 0 12mm 0; page-break-after: avoid; }
...
open("pdf.html", "w", encoding="utf-8").write(doc)
print("pdf.html written,", len(doc), "chars")
