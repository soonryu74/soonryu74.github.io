...
-- 실무과정 30회차 (2026-09-24 확정 편성, 6부). 1~11회차는 교재 1·2호 완성.
insert into public.edu_lessons (course_id, seq, title, summary) values
  ...
  ('care', 15, '3부 · 치매가 있는 어르신 ① 사정',          '본인 의사 확인, 사정에서 놓치기 쉬운 것'),
  ('care', 16, '3부 · 치매가 있는 어르신 ② 연계와 점검',   '치매관리·주야간보호·맞춤돌봄 의뢰, 악화 신호 보고'),
  ('care', 17, '3부 · 뇌혈관질환 후 퇴원 ① 사정과 의료 연계', '퇴원 요약을 계획 언어로, 재택의료·방문간호 의뢰'),
  ('care', 18, '3부 · 뇌혈관질환 후 퇴원 ② 요양·돌봄 조합', '장기요양 급여·월한도액, 재가의료급여, 간병 네 제도, 유사중복'),
  ('care', 19, '3부 · 낙상·골절 후 집으로',                 '주거 사정, 응급안전·주거 개선 연계, 재발 대비 계획'),
  ('care', 20, '3부 · 임종기 어르신',                        '본인·가족 뜻 확인, 연계 절차, 계획서에 적는 법'),
  ('care', 21, '3부 · 65세 미만 장애인',                     '장애인 서비스와 활동지원의 관계'),
  ('care', 22, '3부 · 혼자 사는 어르신, 끊긴 연결',          '안부 확인, 사각지대 연계, 긴급돌봄, 위험 보고, 지역 특화'),
  ('care', 23, '4부 · 선별',                                  '퇴원환자 선별 기준, 통보와 동의, 연계 세 제도 구별'),
  ('care', 24, '4부 · 평가',                                  '퇴원 전 평가에서 지역이 알아야 할 것, 의료 언어→계획 언어'),
  ('care', 25, '4부 · 의뢰',                                  '의뢰서 서식, 시군구·재택의료센터·방문간호 의뢰 절차'),
  ('care', 26, '4부 · 지자체 연계와 집에서 첫 주',            '사전조사로 잇기, 첫 방문, 모니터링 시작'),
  ('care', 27, '5부 · 문서로 일하기',                         '정보시스템 현재, 회의록·계획서 초안, 시군구가 그대로 쓰는 보고서'),
  ('care', 28, '5부 · 우리 지역 자원 지도와 조례',            '공공데이터 자원 목록, 조례에서 내 기관 자리'),
  ('care', 29, '6부 · 모의 통합지원회의',                     '실시간. 가상 사례로 기관 역할을 맡아 계획 합의'),
  ('care', 30, '6부 · 수료 과제',                             '3부 상황 하나를 골라 익명 사례 판별부터 보고서까지')
on conflict (course_id, seq) do nothing;
